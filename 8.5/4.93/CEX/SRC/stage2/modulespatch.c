...
void patch_vsh()
{
	...
	if(vsh_process && coldboot_mode && !safe_mode)
	{
		...
		process_write_memory(vsh_process, (void *)coldboot1_offset, &patch1, 4, 1);
		process_write_memory(vsh_process, (void *)coldboot2_offset, &patch2, 4, 1);
	}
	...
	if(vsh_process && demo_c00_mode && !safe_mode)
	{
		...
		process_write_memory(vsh_process, (void *)demo_c00_offset, &patch, 4, 1);
	}
}
