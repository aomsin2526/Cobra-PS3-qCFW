...
static SprxPatch explore_plugin_patches[] =
{
	...
	{ ps2_nonbw_offset, LI(R0, 1), &condition_ps2softemu },
	{ trophy_title_xmb_patch, 0x4800005c, &hidden_trophy_mode },
	{ trophy_details_xmb_patch, LI(R9, 1), &hidden_trophy_mode },
	{ trophy_icon_xmb_patch, LI(R3, 1), &hidden_trophy_mode },
	{ 0 }
};
...
static SprxPatch explore_category_psn_patches[] =
{
	...
	{ trophy_details_xmb_patch2, LI(R9, 1), &hidden_trophy_mode },
	{ trophy_icon_xmb_patch2, LI(R3, 1), &hidden_trophy_mode },
	{ 0 }
};
...
static SprxPatch np_trophy_plugin_patches[] =
{
	...
	{ trophy_details_ingame_patch, LI(R3, 1), &hidden_trophy_mode },
	{ trophy_icon_ingame_patch, LI(R3, 1), &hidden_trophy_mode },
	{ 0 }
};
...
static SprxPatch np_trophy_ingame_patches[] =
{
	...
	{ trophy_details_ingame_patch2, LI(R3, 1), &hidden_trophy_mode },
	{ trophy_icon_ingame_patch2, LI(R3, 1), &hidden_trophy_mode },
	{ 0 }
};
...
void patch_vsh()
{
	...
	if(vsh_process && coldboot_mode && !safe_mode)
	{
		...
		process_write_memory(vsh_process, (vsh_check == VSH_CEX_HASH ? (void *)cex_coldboot1_offset : (void *)dex_coldboot1_offset), &patch1, 4, 1);
		process_write_memory(vsh_process, (vsh_check == VSH_CEX_HASH ? (void *)cex_coldboot2_offset : (void *)dex_coldboot2_offset), &patch2, 4, 1);
	}
	...
	// Disable c00 demo (By Evilnat)
	// This patch is only for CFWs 4.92 with c00 unlocker patch applied in vsh.self
	if(vsh_process && demo_c00_mode && !safe_mode)
	{
		uint32_t patch = 0x7FC307B4;
		process_write_memory(vsh_process, (vsh_check == VSH_CEX_HASH ? (void *)cex_demo_c00_offset : (void *)dex_demo_c00_offset), &patch, 4, 1);
	}
}
